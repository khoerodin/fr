(function (Bisnis) {
    ...
    Bisnis.Billing.Areas.fetchAll = function (params, successCallback, errorCallback) {
        Bisnis.request({
    ...
    var loadGrid = function (pageNum) {
        ...
        Bisnis.Billing.Areas.fetchAll([{page: pageNum}],
            function (dataResponse) {
                ...
                Bisnis.Util.Dialog.alert('PERHATIAN', 'GAGAL MEMUAT DATA WILAYAH TAGIH');
            }
        );
    };
